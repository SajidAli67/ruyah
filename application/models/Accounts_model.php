...
class Accounts_model extends CI_Model {
	...
	// function get_record_db_purchase($tbl,$id)
    // {
    //     return $this->db->get_where($tbl,array('purchase_code'=>$id))->row_array();
    // }
	// function get_record($tbl,$id)
    // {
    //     return $this->db->get_where($tbl,array('id'=>$id))->row_array();
    // }
    // function get_record_db_salespaymentsreturn($tbl,$id)
    // {
    //     return $this->db->get_where($tbl,array('sales_id'=>$id))->row_array();
    // }
    // function get_record_db_purchasepayments($tbl,$id)
    // {
    //     return $this->db->get_where($tbl,array('payment_code'=>$id))->row_array();
    // }
