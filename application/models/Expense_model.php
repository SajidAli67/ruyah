...
class Expense_model extends CI_Model
{
	...
	public function verify_and_save()
	{
		...
		if ($expense_amt > $check_balance) {
			return 'You ' . $payment_type . ' Account balance is less then ' . $expense_amt;
		}

		if ($expense_amt > $check_balance_byType) {
			return 'You Account balance is less then ' . $expense_amt;
		}
