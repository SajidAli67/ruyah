                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       ...
                       <div class="input-group date">
                         ...
                         <input type="text" class="form-control pull-right datepicker"  id="from_date" name="from_date" value="<?= date('Y-m-d'); ?>">
                      </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                       ...
                       <div class="input-group date">
                         ...
                         <input type="text" class="form-control pull-right datepicker"  id="to_date" name="to_date" value="<?= date('Y-m-d'); ?>">
                      </div>
                       <span id="transfer_date_msg" style="display:none" class="text-danger"></span>
                    </div>
                  </div>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered custom_hover" width="100%">
                ...
                <tr >
                  ...
                  <th style="text-align: center;" colspan="2"><?= $this->lang->line('debit_amount'); ?></th>
                  <th  style="text-align: center;" colspan="2"><?= $this->lang->line('credit_amount'); ?></th>
