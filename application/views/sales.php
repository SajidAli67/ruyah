                                        ...
                                        <table class="table table-hover table-bordered" style="width:100%" id="sales_table">
                                             <thead class="custom_thead">
                                                <tr class="bg-primary" >
                                                   ...
                                                   <th style="display: <?=($this->data['vat_status_list']['status'] == "Non VAT") ? 'none' : 'block'; ?>;" rowspan='2' style="width:10%"><?= $this->lang->line('tax_amount'); ?></th>
                                                   <th style="display: <?=($this->data['vat_status_list']['status'] == "Non VAT") ? 'none' : 'block'; ?>;" rowspan='2' style="width:5%"><?= $this->lang->line('tax'); ?></th>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <div class="col-sm-4" style="display: <?=($this->data['vat_status_list']['status'] == "Non VAT") ? 'none' : 'block'; ?>;">
