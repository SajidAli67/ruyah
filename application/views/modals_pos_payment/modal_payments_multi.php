  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn bg-maroon btn-lg make_sale btn-lg" onclick="save(false,false,'cash/bank')"><i class="fa  fa-save "></i> Save</button>
        <button type="button" class="btn btn-success btn-lg make_sale btn-lg" onclick="save(true,false,'cash/bank')"><i class="fa  fa-print "></i> Save & Print</button>
