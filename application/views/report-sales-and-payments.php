                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-sm-3">
                                    <select class="form-control select2 " id="customer_id" name="customer_id">
                                       ...
                                       <?= get_customers_select_list($default_id,get_current_store_id());?>
                                    </select>
                        ...
                        <div class="box-body table-responsive no-padding">
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 ...
                                 <tr hidden>
                                    <td hidden><?= $this->lang->line('previous_due'); ?></td>
                                    <td hidden colspan="9" id="previous_due">
                                    </td>
                                 </tr>
                                 <tr class="bg-blue">
                                    <th style="">#</th>
                                    ...
                                    <th hidden style=""><?= $this->lang->line('referenced_bill_no'); ?></th>
