                        ...
                        <div class="box-body">
                          ...
                          <div class="row">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4" style="display: <?= ($vat_status_list['status'] == "Non VAT") ? 'none' : 'block'; ?>;">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control only_currency" id="purchase_price" name="purchase_price" placeholder="Total Price"  value="<?php print $purchase_price; ?>" readonly='' >
