...
<body onload="window.print();"><!-- window.print() -->
                  ...
                  <table style="width: 100%;" class="style_hidden fixed_table">
                    ...
                    <tr>
                      <td colspan="8">
                        ...
                        <span style="font-size: 11px;">
                          <b><?php echo  $deposit->deposit_code; ?></b>
                        </span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="8">
                        Reference No.<br>
                        <span style="font-size: 10px;">
                          <b><?php echo $deposit->reference_no; ?></b>
                        </span>
                      </td>
  ...
  <div style="width: 80%;  margin: 15px auto; border: 0.5pt solid #000;">
         <center>
          <h3> <strong>سند قبض<br> Cash receipt </strong></h3>
          </center>
  </div>
    ...
    <div style="width: 80%;  margin: 15px auto; border:0px;">
        ...
        <div >
          <table width="100%"  >
            <tr>
              <td style="padding: 10px"> <center><?=  $deposit->amount ?> </center></td>
              <td style="padding: 10px">   <center> <?=  show_date($deposit->created_date) ?>  </center></td>
            </tr>
          </table>
        ...
        <div style="border: 0.5pt solid #000; margin-top: 15px; ">
          <div style=" padding: 10px">
            <span style="width: 2%;"> Received from account </span> 
              <span style="border-bottom: 1px solid #000; text-align:center"> 
              <strong> <?=get_customer_details($deposit->credit_account_id)->customer_name;  ?> </strong> </span>  
              <span style="float:right; ">ستلمنا من حساب </span>  
          </div>
        </div>
        ...
        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
            ...
            echo  strtoupper($f->format($deposit->amount));
            ?> </strong> </span> 
        ...
        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
              <center> <h5><strong> <?= $deposit->payment_type ?></strong></h5> </center>
          </div>
        </div>

        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
            <span style="width: 2%;"> Being</span> <span style="border-bottom: 1px solid #000; text-align:center"> 
              <strong> <?=  $deposit->note ?> </strong> </span>  <span style="float:right; ">وذلك مقابل</span>  
          </div>
        </div>
...
<table>
    <tfoot style="position: absolute; bottom:10px">
