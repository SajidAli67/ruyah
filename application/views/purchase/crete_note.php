...
<!-- TABLES CSS CODE -->
<?php
$this->load->view('comman/code_css') ?>
<!-- </copy> -->  
<style type="text/css">
...
<div class="wrapper">
 ...
 $CI =& get_instance();
  ...
  <div class="content-wrapper">
    <!-- **********************MODALS***************** -->
    <?php $this->load->view('modals/modal_supplier'); ?>
    <?php $this->load->view('modals/modal_purchase_item.php') ?>
    <?php $this->load->view('modals/modal_item.php'); ?>
    <?php $this->load->view('modals/modal_item_or_service.php'); ?>
               ...
               <!-- ********** ALERT MESSAGE END******* -->
                  ...
                  <div class="col-md-12">
                     ...
                     <div class="box box-primary " >
                        ...
                        <!-- form start -->
                         <!-- OK START -->
                        <?= form_open('#', array('class' => 'form-horizontal', 'id' => 'purchase-form-crete-note', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
