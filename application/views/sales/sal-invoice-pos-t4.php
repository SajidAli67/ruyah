...
<body onload="window.print();"><!--  -->
	...
	$sale_details = get_sales_details($sales_id);
						...
						<td style="width:50%" align="right">
							<table>
								...
								<tr>
									...
									<td width="40%" align="right"><?= 'Debit Note No'; ?></td>
								...
								<tr>
									<td align="right"><?= $this->lang->line('date') . ":"  ?></td>
									<td align="right"><?= $sales_date  ?></td>
								</tr>

								<tr>
									<td align="right"><?=  $this->lang->line('time'). ":"  ?></td>
									<td align="right"><?=  $created_time; ?></td>
								</tr>

								<tr>
									<td align="right"><?=   "Agains Sales Invoice:"  ?></td>
									<td align="right"><?=  $sale_details->sales_code; ?></td>
								</tr>

								<tr>
									<td align="right"><?=   "Sale date:"  ?></td>
									<td align="right"><?=  show_date($sale_details->sales_date); ?></td>
								</tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						...
						$this->db->select("a.id, a.description,c.mrp,c.item_name, a.sales_qty,a.tax_type,
                                  ...
                                  a.total_cost , d.unit_name,c.sku,c.hsn,e.sale_id, f.unit_price as debit_price,
								  f.qty as debit_qty,f.tax_amt as debit_tax
						...
						foreach ($q2->result() as $res2) {
							...
							echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'>" . store_number_format($res2->price_per_unit) . "</td>";

							
							
							echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'>" . store_number_format($res2->debit_price) . "</td>";

							echo "<td style='text-align: center;padding-left: 2px; padding-right: 2px;'>" . store_number_format($res2->debit_tax) . "</td>";
							...
							echo "<td style='text-align: right;padding-left: 2px; padding-right: 2px;' >" . store_number_format( $res2->debit_price + $res2->debit_tax) . "</td>";

							echo "</tr>";

							//$tot_qty+=$res2->sales_qty;

							$subtotal += ($res2->debit_price);

							$tax_amt += $res2->debit_tax;
					...
					<tfoot>
						...
						<tr>
							...
							<td style=" padding-left: 2px; padding-right: 2px;" align="right"><?= store_number_format($subtotal + $tax_amt); ?></td>
	...
	<center>
		...
		<div class="row no-print">
			...
			<div class="col-md-2 col-md-offset-4">
				<a href="<?= base_url('sales'); ?>"><button type="button" class="btn btn-block btn-danger btn-xs" title="Back">Back</button></a>
			</div>
