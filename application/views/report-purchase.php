                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr>
                                    ...
                                    <td colspan="9" id="supplier_name">
                                    </td>
                                 </tr>
                                 <tr>
                                    <td><?= $this->lang->line('mobile'); ?></td>
                                    <td colspan="9" id="supplier_mobile">
                                    </td>
                                 </tr>
                                 <tr class="bg-blue">
                                    <th style="">#</th>
                                    ...
                                    <th hidden style="">Description</th>
                                    <th style=""><?= $this->lang->line('bill_amount'); ?>(<?= $CI->currency(); ?>)</th>
                                    <th hidden style=""><?= $this->lang->line('qty'); ?></th>
                                    <th  style=""><?= $this->lang->line('bill_amount'); ?>(<?= $CI->currency(); ?>)</th>
                                    <th style="">Paid(<?= $CI->currency(); ?>)</th>
      ...
      <script>
         ...
         $("#supplier_id").on('select2:select', function(e) {
            if(e.params!=undefined){
                  ...
                  $("#supplier_name").html(selectedOption.text);
                  $("#supplier_mobile").html(selectedOption.mobile);
            }
           });
      </script>
