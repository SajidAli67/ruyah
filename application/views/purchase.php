...
<body class="hold-transition skin-blue sidebar-mini">
                                          ...
                                          <table class="table table-hover table-bordered" style="width:100%" id="purchase_table">
                                             ...
                                             <thead class="custom_thead">
                                                ...
                                                <tr class="bg-primary">
                                                   ...
                                                   <th style="display: <?= ($this->data['vat_status_list']['status'] == "Non VAT") ? 'none' : 'block'; ?>;" rowspan='2' style="width:7.5%"><?= $this->lang->line('tax_amount'); ?></th>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="display: <?= ($vat_status_list['status'] == "Non VAT") ? 'none' : 'block'; ?>;">
   ...
   <script>
      ...
      $(document).on('click','.btn_add_sn_number',function(){
        var row_no =  $(this).attr('sn_id');
        var tr =  $('#sn_number_tr_'+row_no).show(500) 
         
      })

      $(document).on('keyup','.sn_input',delay(function(e){
         var row_no =  $(this).attr('sn_id');
      
        var sn_number_value = $('#sn_number_'+row_no).val();
        var sn_number = $.trim($(this).val());
      
        $('.sn_number_area_'+row_no).append("<span class='badge badge-secondary'> " + sn_number + "</span>")

        if (sn_number_value.length > 0) {
           $('#sn_number_'+row_no).val(sn_number_value + ',' + sn_number)
        } else {
           $('#sn_number_'+row_no).val(sn_number)
        }
