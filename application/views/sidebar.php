    ...
    <ul class="sidebar-menu">
      ...
      <?php if (!is_user()) { ?>
        ...
        <?php if ($CI->permissions('expense_add') || $CI->permissions('expense_view') || $CI->permissions('expense_category_add') || $CI->permissions('expense_category_view')) { ?>
          ...
          <li class="expense-list-active-li expense-active-li expense-category-active-li expense-category-list-active-li treeview" hidden>
      ...
      <?php if ($change_password = true) { ?>
        ...
        <li class=" site-settings-active-li  change-pass-active-li dbbackup-active-li  tax-active-li currency-view-active-li  store_profile-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li gateways-active-li default-active-li package-active-li subscription-active-li  subscription-list-active-li  package-list-active-li sms-api-active-li smtp-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="default-active-li"><a href="<?php echo base_url('DefaultSetting') ?>"><i class="fa fa- fa-credit-card  "></i> <span><?= $this->lang->line('default_setting'); ?></span>
            ...
            <?php if (!is_user()) { ?>
              ...
              <?php if ($CI->permissions('subscription') && store_module()) { ?>
                ...
                <li class="subscription-active-li  subscription-list-active-li"><a href="<?php echo $base_url; ?>VAT"><i class="fa fa-check  "></i> <span><?= $this->lang->line('vat_status'); ?></span>
            ...
            <li class="change-pass-active-li"><a href="<?php echo $base_url; ?>ExportController/exportDatabase"><i class="fa fa-lock "></i> <span><?= $this->lang->line('store_backup'); ?></span></a></li>
            <li class="change-pass-active-li"><a href="<?php echo $base_url; ?>ImportController"><i class="fa fa-lock "></i> <span><?= $this->lang->line('store_backup_import'); ?></span></a></li>
