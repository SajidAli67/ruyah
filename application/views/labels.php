...
<!-- ./wrapper -->
      ...
      <script>
        ...
        failed.play();
         ...
         //    disp_setting+="scrollbars=yes,width=800, height=1900, left=100, top=25";
         ...
         //       docprint.document.write('<style type="text/css">body{ margin-top:0px; ');
         //       docprint.document.write('font-family:verdana,Arial;color:#000;');
         //       docprint.document.write('font-family:Verdana, Geneva, sans-serif; font-size:12px;}');
         //       docprint.document.write('a{color:#000;text-decoration:none;} div{line-height:1in;width:2.5in;display:inline-block;overflow:hidden} </style>');
         //       docprint.document.write('</head><body onLoad="window.print().innerHTML">');
...
function PrintMe(DivID) {
    var disp_setting = "toolbar=yes,location=no,";
    disp_setting += "directories=yes,menubar=yes,";
    disp_setting += "scrollbars=yes,width=800,height=900,left=100";
    ...
    printWindow.document.write('<head><title>Print Preview</title>');
    printWindow.document.write('<style type="text/css">');
    printWindow.document.write('body { height:auto}');
    printWindow.document.write('div { height: 2in;line-height: 1in;width: 2.5in !important;page-break-after:always; }');
...
//              function myTable() {
//     var divToPrint = document.getElementById('preview_data');
//     var htmlToPrint = '' +
//         '<style type="text/css">' +
//         'table th, table td {' +
