                        ...
                        <div class="tab-pane active" id="tab_4">
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-5">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <div class="col-sm-8">
                                                <select class="form-control select2" id="country" name="country" style="width: 100%;" readonly onkeyup="shift_cursor(event,'state')" value="<?php print $country; ?>">
                                                   <?php
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group">
                                       <label for="address" class="col-sm-4 control-label" style="text-align:left;"><?= $this->lang->line('address'); ?><label class="text-danger">*</label></label>
                                       <div class="col-sm-12">
                                          <textarea type="text" id="address" class="form-control" id="address" name="address" placeholder=""><?php print $address; ?></textarea>
