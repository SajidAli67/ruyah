          ...
          <div class="row invoice-info">
            ...
            <div class="col-sm-6 invoice-col">
              ...
              <address>
                ...
                <?php
                // Sample content retrieved from the database
                $databaseContent = $company_address;

                // Convert HTML entities back to their original characters
                $decodedContent = html_entity_decode($databaseContent);

                // Output the decoded content with formatting
                echo $decodedContent;
                ?>
