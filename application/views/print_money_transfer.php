...
<body onload="window.print();"><!-- window.print() -->
                  ...
                  <table style="width: 100%;" class="style_hidden fixed_table">
                    ...
                    <tr>
                      <td colspan="8">
                        ...
                        <span style="font-size: 11px;">
                          <b><?php echo  $transfer->transfer_code; ?></b>
                        </span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="8">
                        Reference No.<br>
                        <span style="font-size: 10px;">
                          <b><?php echo $transfer->reference_no; ?></b>
                        </span>
                      </td>
  ...
  <div style="width: 80%;  margin: 15px auto; border: 0.5pt solid #000;">
         <center>
          <h3> <strong>سند صرف<br> Payment voucher </strong></h3>
          </center>
  </div>
    ...
    <div style="width: 80%;  margin: 15px auto; border:0px;">
        ...
        <div >
          <table width="100%"  >
            <tr>
              <td style="padding: 10px"> <center><?=  $transfer->amount ?> </center></td>
              <td style="padding: 10px">   <center> <?=  show_date($transfer->created_date) ?>  </center></td>
            </tr>
          </table>
        ...
        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
            ...
            echo  strtoupper($f->format($transfer->amount));
            ?> </strong> </span> 
        ...
        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
              <center> <h5><strong> <?= $transfer->payment_type ?></strong></h5> </center>
          </div>
        </div>
        ...
        <div style="border: 0.5pt solid #000;">
          <div style=" padding: 10px">
            <span style="width: 2%;"> Being</span> <span style="border-bottom: 1px solid #000; text-align:center"> 
              <strong> <?=  $transfer->note ?> </strong> </span>  <span style="float:right; ">وذلك مقابل</span>  
          </div>
        </div>
