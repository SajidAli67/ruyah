                           ...
                           <table class="table table-bordered table-hover " id="report-data" >
                              <thead>
                                 <tr class="bg-blue">
                                    ...
                                    <th style="" hidden><?= $this->lang->line('customer_name'); ?></th>
                                    <th style="" hidden>Invoice Type</th>
                                    <th style="" hidden><?= $this->lang->line('category'); ?></th>
                                    <th style=""><?= $this->lang->line('quantity'); ?></th>
                                    <th style="">Stock</th>
                                    <th style="" hidden><?= $this->lang->line('unit_price'); ?>(<?= $CI->currency(); ?>)</th>
                                    <th style="" hidden><?= $this->lang->line('total'); ?>(<?= $CI->currency(); ?>)</th>
                                 </tr>
                              </thead>
                              <tbody id="tbodyid">
                              </tbody>
