...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-6">
        <h4>Status:</h4>
        <span style="font-size:30px" class="badge bg-success p-3">The System currently you are using is providing <?php echo $vat_status_list['status']; ?> Functionalities</span> <!-- Replace "VAT" with the appropriate status text -->
        <!-- If it's not VAT, use the Bootstrap badge with 'bg-danger' class -->
        <!-- <span class="badge bg-danger p-3">Not VAT</span> -->
      </div>
    </div>
  </div>
  <div class="container mt-5">
