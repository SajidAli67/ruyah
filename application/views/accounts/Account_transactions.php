...
$row[] = $description;
			$row['3'] = ($account_cr_dr=='Debit_entry') ? store_number_format($accounts->debit_amt) : '';
			if($account_cr_dr=='Debit_entry'){
				$row['4'] = "";
			}elseif($account_cr_dr=='Credit_entry'){
				$row['4'] = "Credit";
			}
			$row['5'] = ($account_cr_dr=='Credit_entry') ? store_number_format($accounts->credit_amt) : '';
