...
$str1.=" UNION ";
        	...
        	$result_opening_balance = 0;
        			...
        			if(!empty($from_date)){
        				// exit();
        				// echo "<tr>";
 $result_opening_balance = $this->show_item_sales_report123($from_date); // Call another function
 $tot_bal = $result_opening_balance;
  echo "<td colspan='2' style='text-align:left'>";
echo "<b>Today's Opening Stock is: </b>";
  echo "</td>";
  echo "<td colspan='2' style='text-align:right'>";
 // echo "Testjhskjhdkfj".$result_opening_balance;
 echo store_number_format($tot_bal);
  echo "</td>";
  echo "</tr>";  
}
        		...
        		foreach ($q1->result() as $res2){
        			...
        			// 				: get_sales_payment_details($res2->id);
        							...
        							elseif ($res2->tr_type ==	'purchase') {
        								...
        								// echo "<pre>";print_r($res2->return_id);
        							}
...
// Quantity In sales_and_payments
	                  ...
	                  // $tot_bal = ($res2->tr_type=='invoice') ? $details->grand_total+$tot_bal : $tot_bal-$details->payment ;
	                  $resStockQuantity = $res2->stock_quantity;
	                  if($res2->tr_type=='invoice'){
	                 ...
	                 // Stop8
	                  ...
	                  // if($res2->tr_type=='purchase' OR $res2->tr_type=='return'){

	                  // 	$tot_qty +=$res2->stock_quantity;
...
// 		$this->db->select("a.id,a.sales_code,a.sales_date,b.customer_name,b.customer_code,a.grand_total,a.paid_amount,a.store_id,c.unit_total_cost,c.total_cost,e.category_name,d.stock as items_stock");
...
// 			$q1=$this->db->get();
// 		// $fetch_stock = $q1->result();
// 		// echo "<pre>"; print_r($fetch_stock['0']->items_stock);exit();
...
// 			$tot_sales_qty=0;
// 			$opening_stock = 0;
// 			$item_total_stock = $q1->result()['0']->items_stock;
// 			echo "<tr hidden>";
// echo "<td colspan='3' style='text-align:center'>Remaining Stock:</td>";
// echo "<td colspan='2' style='text-align:center'>".$item_total_stock. "</td>";
// 			echo "</tr>";
// 			foreach ($q1->result() as $res1) {
...
// 				echo "<td hidden>".$res1->items_stock."</td>";

// 				echo "<td >".$res1->item_name."</td>";

// 				echo "<td hidden>".$res1->category_name."</td>";

// 				echo "<td>".format_qty($res1->sales_qty)."</td>";

// 				echo "<td class='text-right' hidden>".store_number_format($res1->unit_total_cost)."</td>";

// 				echo "<td class='text-right' hidden>".store_number_format($res1->total_cost)."</td>";
...
// 					  <td class='text-right text-bold' colspan='$total_columns_count'><b>Opening Stock :</b></td>

// 					  <td class='text-left text-bold'>".format_qty($opening_stock)."</td>

// 					  <td class='text-right text-bold'>Remaining Stock</td>

// 					  <td class='text-right text-bold'>".store_number_format($item_total_stock)."</td>
