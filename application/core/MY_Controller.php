    ...
    public function load_currency_data()
{
    if ($this->session->userdata('logged_in')) {
        ...
        if ($q1->num_rows() > 0) {
            ...
            // Handle the case where no currency data is found
            // You can set default values or perform any other necessary action here.
            // For example:
            $this->session->set_userdata(array(
...
$this->data['vat_status_list'] =$this->vat->get_vat_status_list();
          //If he the Admin
          if($this->session->userdata('inv_userid')==1 OR $this->session->userdata('inv_userid')==2){
            return true;
          }
        ...
        public function permission_check($value=''){// echo"<pre>";	print_r($this->session->userdata('inv_userid'));exit();
        $this->data['vat_status_list'] =$this->vat->get_vat_status_list();
        // print_r($this->data['vat_status_list']);exit();
